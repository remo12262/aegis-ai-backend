...
class AssessmentPayload(BaseModel):
    ...
    org_name: str = ""
    # AES dimensions
    ZDR: list[int]  # Zero-Day Risk
    PV:  list[int]  # Patch Velocity
    AS_:  list[int]  # Attack Surface
    SC:  list[int]  # Supply Chain
    LD:  list[int]  # Legacy Debt
    # DRS dimensions
    SM:  list[int]  # SOC Maturity
    IR:  list[int]  # Incident Response
    TI:  list[int]  # Threat Intelligence
    ZT:  list[int]  # Zero Trust
    RC:  list[int]  # Recovery
    # GCI dimensions
    FA:  list[int]  # Framework Adoption
    AP:  list[int]  # AI Policy
    CO:  list[int]  # Compliance
    VR:  list[int]  # Vendor Risk
    BE:  list[int]  # Board Engagement
